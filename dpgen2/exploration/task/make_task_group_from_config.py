...
def customized_lmp_template_task_group_args():
    ...
    doc_input_extra_files = "Extra files that may be needed to execute the shell commands"
    doc_output_dir_pattern = "Pattern of resultant folders generated by the shell commands."
