...
class AlloyConf:
    ...
    def generate_file_content(
        ...
        for ii in range(numb_confs):
            ss = self._generate_one_sys(concentration, cell_pert_frac, atom_pert_dist)
    ...
    def _generate_one_sys(
        ...
        ret_sys.data["atom_types"] = np.array(
            random.choices(
